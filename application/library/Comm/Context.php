...
class Comm_Context {
    ...
    public static function is_set($key) {
        return isset(self::$context_data[$key]) ? true : false;
    }
    ...
    public static function get_current_url($urlencode = true) {
        ...
        //目前在self::get_server('SERVER_NAME')中的值是v5.weibo.com
